...
TEST_F(ExerciseEditor,XMLOutput)
{
    ...
    "    </VIDEOPATH>\n"
    "    <THUMBNAILPATH>\n"
    "      ${CMAKE_SOURCE_DIR}/build/test/Situp_0_103.webp\n"
    "    </THUMBNAILPATH>\n"
    "    <VIDEOSTARTTIME>\n"
    "      0\n"
    "    </VIDEOSTARTTIME>\n"
...
TEST_F(ExerciseEditor,AddExerciseToExistingXML)
{
    ...
    FreeFit::GUI::ExerciseEditorValidator v(e);
    v.pushAddButton();
    v.setFirstNewExerciseNameText("SomethingElse");
    v.setFirstNewExerciseURLText("https://www.youtube.com/watch?v=1fbU_MkV7NE");
    v.setFirstNewExerciseMuscleArea(1);
    v.setFirstNewExerciseMuscleArea(3);
    ...
    "    </VIDEOURL>\n"
    "    <VIDEOPATH>\n"
    "      ${CMAKE_SOURCE_DIR}/build/test/SomethingElse_0_103.mp4\n"
    "    </VIDEOPATH>\n"
    "    <THUMBNAILPATH>\n"
    "      ${CMAKE_SOURCE_DIR}/build/test/SomethingElse_0_103.webp\n"
    "    </THUMBNAILPATH>\n"
    "    <VIDEOSTARTTIME>\n"
    "      0\n"
    "    </VIDEOSTARTTIME>\n"
