        ...
        public:
            ExerciseEditor()
                :   put_exercise_to_add_list(QApplication::style()->standardIcon(QStyle::SP_MediaSkipForward),"",this),
                    ...
                    video_start_time("Enter video starting time...",this),
                    video_end_time("Enter video end time...",this),
                    ...
                    exercises_to_add(this)
            {
                ...
                ly->addWidget(&video_start_time,++row_counter,1);
                ly->addWidget(&video_end_time,++row_counter,1);
                ...
                ly->addWidget(&muscle_areas,0,0,row_counter,1);
                ly->addWidget(&put_exercise_to_add_list,1,3);
                ly->addWidget(&create_new_exercise,2,3);
                ly->addWidget(&exercises_to_add,0,4,row_counter,1);
                this->setLayout(ly);
            }
        private:
            ...
            QLineEdit name;
            QLineEdit video_url;
            QLineEdit video_start_time;
            QLineEdit video_end_time;
